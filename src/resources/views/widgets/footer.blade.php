<footer class="bg-gray-extra-dark padding-top-bottom-100px">
    <div class="row padding-left-right-twelve-percent"
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 center-col md-margin-bottom-50px sm-text-center">
            <h5 class="text-weight-800 text-white margin-bottom-20px">Podi</h5>
            <p class="text-weight-500 text-extra-large text-gray-light margin-bottom-10px">A multi-purpose podcast
                studio template.</p>
            <div
            ...
            <p class="no-margin"><span class="text-green margin-right-10px uk-icon" data-uk-icon="icon: info; ratio: 1"><svg
                        width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="info"><path
                            ...
                            fill="none" stroke="#000" stroke-width="1.1" cx="10" cy="10" r="9"></circle></svg></span>The
                studio is equipped with multiple microphones and headphones to accommodate several guests or hosts, and
                a mixing board is used to balance the levels of each speaker's voice.
            </p>
        </div>
